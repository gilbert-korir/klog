...
<div class="container-fluid px-4">
    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ url('admin/update-post/'.$post_id) }}" method="POST">
                @csrf
                @method('PUT')

                <div class="mb-3">
                    <label for="">Category</label>
                    <select name="category_id" reruired class="form-control">

                        <option value="{{ $cateitem->id }}">--Select Category--</option>
